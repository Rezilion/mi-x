...
def check_openssl_version(openssl_version):
    ...
    if AFFECTED_VERSIONS[constants.START] <= openssl_version <= AFFECTED_VERSIONS[constants.FIRST] or \
            openssl_version == AFFECTED_VERSIONS[2] or openssl_version == AFFECTED_VERSIONS[constants.END]:
