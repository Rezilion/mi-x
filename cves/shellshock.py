...
def cve_2014_7187(container_name):
    """This function tests if the system is exploitable to CVE-2014-7187."""
    ...
    with subprocess.Popen(exploit_command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True) \
        ...
        print(constants.FULL_QUESTION_MESSAGE.format('Is exploitable to CVE-2014-7187?'))
        if 'CVE-2014-7187 exploitable, word_lineno' in exploit_out:
            print(constants.FULL_NEGATIVE_RESULT_MESSAGE)
            print(constants.FULL_EXPLOITABLE_MESSAGE.format('CVE-2014-7187'))
        else:
            print(constants.FULL_POSITIVE_RESULT_MESSAGE)
            print(constants.FULL_NOT_EXPLOITABLE_MESSAGE.format('CVE-2014-7187'))


def cve_2014_7186(container_name):
    """This function tests if the system is exploitable to CVE-2014-7186."""
    ...
    with subprocess.Popen(exploit_command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True) \
            as pipe_exploit_out:
        exploit_out = pipe_exploit_out.communicate()[constants.START]
        print(constants.FULL_QUESTION_MESSAGE.format('Is exploitable to CVE-2014-7186?'))
        if 'echo' in exploit_out:
            print(constants.FULL_NEGATIVE_RESULT_MESSAGE)
            print(constants.FULL_EXPLOITABLE_MESSAGE.format('CVE-2014-7186'))
        else:
            print(constants.FULL_POSITIVE_RESULT_MESSAGE)
            print(constants.FULL_NOT_EXPLOITABLE_MESSAGE.format('CVE-2014-7186'))


def cve_2014_7169(container_name):
    """This function tests if the system is exploitable to CVE-2014-7169."""
    ...
    with subprocess.Popen(exploit_command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True) \
        ...
        print(constants.FULL_QUESTION_MESSAGE.format('Is exploitable to CVE-2014-7169?'))
        if not exploit_error or 'No such file or directory' in exploit_error:
            print(constants.FULL_POSITIVE_RESULT_MESSAGE)
            print(constants.FULL_NOT_EXPLOITABLE_MESSAGE.format('CVE-2014-7169'))
        else:
            print(constants.FULL_NEGATIVE_RESULT_MESSAGE)
            print(constants.FULL_EXPLOITABLE_MESSAGE.format('CVE-2014-7169'))


def cve_2014_6277_and_cve_2014_6278(container_name):
    """This function tests if the system is exploitable to CVE-2014-6277 or CVE-2014-6278."""
    ...
    with subprocess.Popen(exploit_command, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True) \
            as pipe_exploit_out:
        exploit_out = pipe_exploit_out.communicate()[constants.START]
        print(constants.FULL_QUESTION_MESSAGE.format('Is exploitable to CVE-2014-6277 or CVE-2014-6278?'))
        if 'vulnerable' in exploit_out:
            print(constants.FULL_NEGATIVE_RESULT_MESSAGE)
            print(constants.FULL_EXPLOITABLE_MESSAGE.format('CVE-2014-6277 or CVE-2014-6278'))
        else:
            print(constants.FULL_POSITIVE_RESULT_MESSAGE)
            print(constants.FULL_NOT_EXPLOITABLE_MESSAGE.format('CVE-2014-6277 or CVE-2014-6278'))


def cve_2014_6271(container_name):
    """This function tests if the system is exploitable to CVE-2014-6271."""
    ...
    if 'vulnerable' in exploit_out:
        print(constants.FULL_NEGATIVE_RESULT_MESSAGE)
        print(constants.FULL_EXPLOITABLE_MESSAGE.format('CVE-2014-6271'))
    else:
        print(constants.FULL_POSITIVE_RESULT_MESSAGE)
        print(constants.FULL_NOT_EXPLOITABLE_MESSAGE.format('CVE-2014-6271'))
...
def validate(debug, container_name):
    """This function validates if the host is exploitable to shellshock vulnerabilities."""
...
def validation_flow_chart():
    ...
    vol_graph.node('Exploitable to CVE-2014-6271')
    vol_graph.attr('node', shape='box', style='filled', color='red')
    vol_graph.node('Exploitable to CVE-2014-6277 and CVE-2014-6278')
    vol_graph.attr('node', shape='box', style='filled', color='red')
    vol_graph.node('Exploitable to CVE-2014-7169')
    vol_graph.attr('node', shape='box', style='filled', color='red')
    vol_graph.node('Exploitable to CVE-2014-7186')
    vol_graph.attr('node', shape='box', style='filled', color='red')
    vol_graph.node('Exploitable to CVE-2014-7187')
    vol_graph.attr('node', shape='box', style='filled', color='green')
    vol_graph.node('Not exploitable to CVE-2014-6271')
    vol_graph.attr('node', shape='box', style='filled', color='green')
    vol_graph.node('Not exploitable to CVE-2014-6277 and CVE-2014-6278')
    vol_graph.attr('node', shape='box', style='filled', color='green')
    vol_graph.node('Not exploitable to CVE-2014-7169')
    vol_graph.attr('node', shape='box', style='filled', color='green')
    vol_graph.node('Not exploitable to CVE-2014-7186')
    vol_graph.attr('node', shape='box', style='filled', color='green')
    vol_graph.node('Not exploitable to CVE-2014-7187')
    vol_graph.attr('node', shape='box', style='filled', color='green')
    vol_graph.node('Not exploitable to shellshock vulnerabilities')
    vol_graph.attr('node', shape='box', color='lightgrey')
    vol_graph.edge('Is it Linux?', 'Not exploitable to shellshock vulnerabilities', label='No')
    vol_graph.edge('Is it Linux?', 'Is bash version affected?', label='Yes')
    vol_graph.edge('Is bash version affected?', 'Not exploitable to shellshock vulnerabilities', label='No')
    vol_graph.edge('Is bash version affected?', 'Is exploitable to CVE-2014-6271', label='Yes')
    vol_graph.edge('Is exploitable to CVE-2014-6271', 'Exploitable to CVE-2014-6271', label='Yes')
    vol_graph.edge('Is exploitable to CVE-2014-6271', 'Not exploitable to CVE-2014-6271', label='No')
    vol_graph.edge('Is bash version affected?', 'Is exploitable to CVE-2014-6277 or CVE-2014-6278', label='Yes')
    vol_graph.edge('Is exploitable to CVE-2014-6277 or CVE-2014-6278', 'Exploitable to CVE-2014-6277 and CVE-2014-6278',
                   label='Yes')
    vol_graph.edge('Is exploitable to CVE-2014-6277 or CVE-2014-6278', 'Not exploitable to CVE-2014-6277 and '
                                                                       'CVE-2014-6278', label='No')
    vol_graph.edge('Is bash version affected?', 'Is exploitable to CVE-2014-7169', label='Yes')
    vol_graph.edge('Is exploitable to CVE-2014-7169', 'Exploitable to CVE-2014-7169', label='Yes')
    vol_graph.edge('Is exploitable to CVE-2014-7169', 'Not exploitable to CVE-2014-7169', label='No')
    vol_graph.edge('Is bash version affected?', 'Is exploitable to CVE-2014-7186', label='Yes')
    vol_graph.edge('Is exploitable to CVE-2014-7186', 'Exploitable to CVE-2014-7186', label='Yes')
    vol_graph.edge('Is exploitable to CVE-2014-7186', 'Not exploitable to CVE-2014-7186', label='No')
    vol_graph.edge('Is bash version affected?', 'Is exploitable to CVE-2014-7187', label='Yes')
    vol_graph.edge('Is exploitable to CVE-2014-7187', 'Exploitable to CVE-2014-7187', label='Yes')
    vol_graph.edge('Is exploitable to CVE-2014-7187', 'Not exploitable to CVE-2014-7187', label='No')
